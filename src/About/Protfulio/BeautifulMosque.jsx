    ...
    return(
        <>
          ...
          <div className="row">
            ...
            <h1 className="text-center about___title"><span>Beautiful</span> Mosque</h1>
                <div className="row home__row mt-5">
                     <div className="col-md-12 col-12 mx-auto">
                         <div className="img_thumbnail">
                            <img src={img2} alt="ecommerce.." className="img-fluid" />

                            <h1 className="pt-5 pb-4"><span>Beautiful</span> Mosque in Bangladesh</h1>
                            ...
                            <ul>
                                <li>Create time: <span>15 feb 2021</span></li>
...
export default BeautifulMosque;