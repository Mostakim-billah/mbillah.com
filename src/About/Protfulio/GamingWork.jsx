...
import img6 from '../../img/Image 17.jpg';
const GamingWork = () => {
    return(
        <>
          ...
          <div className="row">
            ...
            <h1 className="text-center about___title"><span>Gaming</span> Website</h1>
                <div className="row home__row mt-5">
                     <div className="col-md-12 col-12 mx-auto">
                         <div className="img_thumbnail">
                            <img src={img6} alt="ecommerce.." className="img-fluid" />

                            <h1 className="pt-5 pb-4"><span>Difarent Ga</span>ming Website</h1>
                            ...
                            <ul>
                                <li>Create time: <span>30 feb 2021</span></li>
