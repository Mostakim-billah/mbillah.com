...
import img3 from '../../img/Image 4.jpg';
const Islam = () => {
    return(
        <>
          ...
          <div className="row">
            ...
            <h1 className="text-center about___title"><span>Religion</span> Islam</h1>
                <div className="row home__row mt-5">
                     <div className="col-md-12 col-12 mx-auto">
                         <div className="img_thumbnail">
                            <img src={img3} alt="ecommerce.." className="img-fluid" />

                            <h1 className="pt-5 pb-4"><span>Ismal</span> is Complite code of Life</h1>
                            ...
                            <ul>
                                <li>Create time: <span>10 sep 2021</span></li>
