...
import img5 from '../../img/Image 6.jpg';
const Protflulioy = () => {
    return(
        <>
          ...
          <div className="row">
            ...
            <h1 className="text-center about___title"><span>Protfulio</span> Website</h1>
                <div className="row home__row mt-5">
                     <div className="col-md-12 col-12 mx-auto">
                         <div className="img_thumbnail">
                            <img src={img5} alt="ecommerce.." className="img-fluid" />

                            <h1 className="pt-5 pb-4"><span>Personal</span> Landing Web page</h1>
                            ...
                            <ul>
                                <li>Create time: <span>20 aug 2021</span></li>
